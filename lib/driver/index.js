...
function getSingleton() {
	if (driver === null) {
		...
		var DATABASE_URL = _process$env.DATABASE_URL;
		var LEGO_MIN_POOL_SIZE = _process$env.LEGO_MIN_POOL_SIZE;
		var LEGO_MAX_POOL_SIZE = _process$env.LEGO_MAX_POOL_SIZE;
